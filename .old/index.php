    ...
    <main class="container z-30 mx-auto grid grid-cols-1 items-center gap-10 overflow-hidden px-10 sm:grid-cols-12">
        ...
        <section class="rounded-xl bg-white p-10 pt-8 shadow-md sm:col-start-3 sm:col-end-11 lg:col-start-8 lg:col-end-12">
            <div class="flex flex-col gap-6">
                ...
                <form class="flex flex-col gap-3" action="./login/loginAction.php" method="post">
                    ...
                    <article class="flex">
                        <button type="submit" class="mt-2 rounded-lg border-2 border-transparent p-2 px-6 text-sm font-medium text-white transition-colors bg-primary hover:bg-accent active:bg-secondary active:text-accent">Log in</button>
                    </article>
                </form>
            </div>
        </section>
